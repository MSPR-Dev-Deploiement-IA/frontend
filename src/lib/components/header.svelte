...
<header class="flex h-16 items-center justify-between bg-gray-100 px-6 py-4 shadow">
	...
	<nav>
		{#if $userStore}
			...
			<a href="/chat" class="ml-4 text-blue-500">Message</a>
			<a href="/mobile" class="ml-4 text-blue-500">Application Mobile</a>
			<button on:click={logout} class="ml-4 text-blue-500">Logout</button>
		{:else}
			<a href="/auth/login" class="ml-4 text-blue-500">Login</a>
